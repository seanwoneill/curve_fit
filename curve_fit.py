...
x = np.arange(trimmed[0][-1], trimmed[0][0]+1,1)
plt.figure(1)
...
plt.plot(trimmed[0], trimmed[1],'p', color = 'b', label = 'Solvent adj. raw data')
plt.plot(trimmed[0], curve_functions.deriv(trimmed[0], trimmed[1],1),'p', color = 'g', label = 'Solvent adj. raw data')
# plt.plot(trimmed[0], curve_functions.gaussian(x,solvent_gauss_params[0],solvent_gauss_params[1],\
#                                               solvent_gauss_params[2], solvent_gauss_params[3]),'o', color = 'k', label = 'Raw data')
